...
var KTProjectUsers = function () {
    ...
    const table = document.getElementById('kt_table_business_unit');
    const element = document.getElementById('kt_modal_add_bussiness_unit');
    const form = element.querySelector('#kt_modal_add_bussiness_unit_form');
    ...
    var initTable = function () {
        ...
        const cancelButton = element.querySelector('[data-kt-bussiness-unit-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[data-kt-bussiness-unit-modal-action="close"]');
        ...
        // Add new button
        const addNewButton = document.querySelector('[data-bs-target="#kt_modal_add_bussiness_unit"]');
        addNewButton.addEventListener('click', e => {
            e.preventDefault();
            $("#kt_modal_add_bussiness_unit_form *").prop('disabled', false);
            $("#kt_modal_add_bussiness_unit_form *").val('');
            $('#code_header').val('');
            $("#kt_modal_add_bussiness_unit_form *").closest('.invalid-feedback').children().remove();
        });
        ...
        // end ddl
        // Define form element
        const forms = document.getElementById('kt_modal_add_bussiness_unit_form');
    ...
    var callActionCreate = (parameter) => {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { "data": object, "code": $('#code_header').val(), "location": $('#code_location').val() },
            dataType: 'json',
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.success == 'true') {
                ...
                if (action === 'view') {
                    $("#kt_modal_add_bussiness_unit_form *").prop('disabled', true);
                } else {
                    $("#kt_modal_add_bussiness_unit_form *").prop('disabled', false);
                }

                $("#kt_modal_add_bussiness_unit_form *").closest('.invalid-feedback').children().remove();
                $('#kt_modal_add_bussiness_unit').modal('show');
            } else {
            ...
            $.ajax({
                ...
                success: function (result) {
                    Swal.fire({
                        ...
                        modal.hide();
                        window.location.href = "BusinessUnit/Index";
                    });
                },
                error: function (e, t, s) {
                    var errorMessage = e.message;
